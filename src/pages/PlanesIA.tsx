      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mt-12">
          ...
          <ol className="mt-3 list-decimal list-inside space-y-2 text-muted-foreground">
            ...
            <li>{t('planesIA.step4')}</li>
          </ol>
          <div className="mt-6 flex gap-3">
            <Link to="/auth"><Button className="bg-blue-600 hover:bg-blue-700">{t('planesIA.createPlanNow')}</Button></Link>
            <Link to="/agente-ia-oposiciones"><Button variant="outline">{t('planesIA.backToAgent')}</Button></Link>
          </div>
        </section>
      </div>
    </div>
