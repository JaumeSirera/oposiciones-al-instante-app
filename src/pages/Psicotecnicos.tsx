      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mt-12">
          ...
          <div className="mt-6 flex gap-3">
            <Link to="/auth"><Button className="bg-blue-600 hover:bg-blue-700">{t('psychotechnics.startButton')}</Button></Link>
            <Link to="/agente-ia-oposiciones"><Button variant="outline">{t('psychotechnics.backToAgent')}</Button></Link>
          </div>
        </section>
      </div>
    </div>
